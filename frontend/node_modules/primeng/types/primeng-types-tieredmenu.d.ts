 ...
 * @group Interface
 */
interface TieredMenuPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type TieredMenuPassThrough<I = unknown> = PassThrough<I, TieredMenuPassThroughOptions<I>>;
/**
 * Custom item template context.
 * @group Interface
 */
interface TieredMenuItemTemplateContext {
    /**
     * Item instance.
     */
    $implicit: any;
...
export type { TieredMenuItemTemplateContext, TieredMenuPassThrough, TieredMenuPassThroughOptions, TieredMenuTemplates };
