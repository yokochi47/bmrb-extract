 ...
 * @group Interface
 */
interface TerminalPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type TerminalPassThrough<I = unknown> = PassThrough<I, TerminalPassThroughOptions<I>>;

export type { TerminalPassThrough, TerminalPassThroughOptions };
