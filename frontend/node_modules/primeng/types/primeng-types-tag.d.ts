 ...
 * @group Interface
 */
interface TagPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type TagPassThrough<I = unknown> = PassThrough<I, TagPassThroughOptions<I>>;
/**
...
export type { TagPassThrough, TagPassThroughOptions, TagTemplates };
