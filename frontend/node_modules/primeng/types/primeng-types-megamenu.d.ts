 ...
 * @group Interface
 */
interface MegaMenuPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type MegaMenuPassThrough<I = unknown> = PassThrough<I, MegaMenuPassThroughOptions<I>>;
/**
 * Custom item template context.
 * @group Interface
 */
interface MegaMenuItemTemplateContext {
    /**
     * Menu item instance.
     */
    $implicit: MenuItem;
...
export type { MegaMenuItemTemplateContext, MegaMenuPassThrough, MegaMenuPassThroughOptions, MegaMenuTemplates };
