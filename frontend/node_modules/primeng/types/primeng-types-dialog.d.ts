 ...
 * @group Interface
 */
interface DialogPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type DialogPassThrough<I = unknown> = PassThrough<I, DialogPassThroughOptions<I>>;
/**
...
export type { DialogPassThrough, DialogPassThroughOptions, DialogTemplates };
