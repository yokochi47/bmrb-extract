...
import { PassThrough, PassThroughOption, FilterMetadata, LazyLoadMeta } from 'primeng/api';
import { ButtonPassThrough, ButtonProps } from 'primeng/types/button';
 ...
 * @group Interface
 */
interface ColumnFilterPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type ColumnFilterPassThrough<I = unknown> = PassThrough<I, ColumnFilterPassThroughOptions<I>>;
/**
 ...
 * @group Interface
 */
interface TablePassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type TablePassThrough<I = unknown> = PassThrough<I, TablePassThroughOptions<I>>;
/**
 * Custom select event.
...
export type { ColumnFilterPassThrough, ColumnFilterPassThroughOptions, ExportCSVOptions, TableColResizeEvent, TableColumnReorderEvent, TableContextMenuSelectEvent, TableContextMenuSelectionChangeEvent, TableEditCancelEvent, TableEditCompleteEvent, TableEditEvent, TableEditInitEvent, TableFilterButtonInlinePropsOptions, TableFilterButtonPopoverPropsOptions, TableFilterButtonPropsOptions, TableFilterEvent, TableHeaderCheckboxToggleEvent, TableLazyLoadEvent, TablePageEvent, TablePassThrough, TablePassThroughOptions, TableRowCollapseEvent, TableRowExpandEvent, TableRowReorderEvent, TableRowSelectEvent, TableRowUnSelectEvent, TableSelectAllChangeEvent, TableTemplates };
