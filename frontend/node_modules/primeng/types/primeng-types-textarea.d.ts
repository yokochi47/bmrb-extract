 ...
 * @group Interface
 */
interface TextareaPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type TextareaPassThrough<I = unknown> = PassThrough<I, TextareaPassThroughOptions<I>>;

export type { TextareaPassThrough, TextareaPassThroughOptions };
