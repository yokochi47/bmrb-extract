 ...
 * @group Interface
 */
interface AutoCompletePassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type AutoCompletePassThrough<I = unknown> = PassThrough<I, AutoCompletePassThroughOptions<I>>;
/**
 ...
 * @group Interface
 */
interface AutoCompleteItemTemplateContext<T = any> {
    /**
     * Data of the option.
     */
    $implicit: T;
 ...
 * @group Interface
 */
interface AutoCompleteGroupTemplateContext<T = any> {
    /**
     * Group option.
     */
    $implicit: T;
 ...
 * @group Interface
 */
interface AutoCompleteSelectedItemTemplateContext<T = any> {
    /**
     * Selected option value.
     */
    $implicit: T;
 ...
 * @group Interface
 */
interface AutoCompleteLoaderTemplateContext {
    /**
 ...
 * @group Interface
 */
interface AutoCompleteRemoveIconTemplateContext {
    /**
 ...
 * @group Templates
 */
interface AutoCompleteTemplates<T = any> {
    /**
