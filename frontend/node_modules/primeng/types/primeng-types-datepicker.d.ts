 ...
 * @group Interface
 */
interface DatePickerPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type DatePickerPassThrough<I = unknown> = PassThrough<I, DatePickerPassThroughOptions<I>>;
/**
 * Represents metadata for a single date cell in the DatePicker.
 * @group Interface
 */
interface DatePickerDateMeta {
    /**
 ...
 * @group Interface
 */
interface DatePickerDateTemplateContext {
    /**
 ...
 * @group Interface
 */
interface DatePickerDisabledDateTemplateContext {
    /**
 ...
 * @group Interface
 */
interface DatePickerDecadeTemplateContext {
    /**
 ...
 * @group Interface
 */
interface DatePickerInputIconTemplateContext {
    /**
 ...
 * @group Interface
 */
interface DatePickerButtonBarTemplateContext {
    /**
