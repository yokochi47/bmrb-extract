 ...
 * @group Interface
 */
interface MeterGroupPassThroughOptions<I = unknown> {
    /**
 ...
 * @template I Type of instance.
 */
type MeterGroupPassThrough<I = unknown> = PassThrough<I, MeterGroupPassThroughOptions<I>>;
/**
 * Custom label template context.
 * @group Interface
 */
interface MeterGroupLabelTemplateContext {
    /**
 ...
 * @group Interface
 */
interface MeterGroupMeterTemplateContext {
    /**
     * Current meter item.
     */
    $implicit: MeterItem;
 ...
 * @group Interface
 */
interface MeterGroupIconTemplateContext {
    /**
     * Current meter item.
     */
    $implicit: MeterItem;
...
export type { MeterGroupIconTemplateContext, MeterGroupLabelTemplateContext, MeterGroupMeterTemplateContext, MeterGroupPassThrough, MeterGroupPassThroughOptions, MeterGroupTemplates, MeterItem };
