...
INPUT_FILE_TYPE_LABELS = {
    ...
    'nm-shi': 'Assigned chemical shifts (NMR-STAR V3 or NEF)',
    ...
    'nm-res-sch': 'NMR restraints (Schrödinger/ASL format)',
    'nm-res-syb': 'NMR restraints (SYBYL format)',
    'nm-res-xpl': 'NMR restraints (XPLOR-NIH format)',
    'nm-res-oth': 'NMR restraints (other plain text format)',
    ...
    'nm-pea-any': 'Spectral peak list (any plain text format, auto format detection)',
